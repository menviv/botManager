 ...
 * Get Paths list 
 */
router.get('/GetMyPaths/', function(req, res) {

    var cursor = collPaths.find({});
    var result = [];
...
/*
 * Get Option list by Path
 */
router.get('/GetOptsByPath/:id', function(req, res) {

    var PathID = req.params.id;

    var o_id = new mongo.ObjectID(PathID);

    var cursor = collOpts.find({'PathID': o_id});
    var result = [];
    cursor.each(function(err, doc) {
        if(err)
            throw err;
...
/*
 * POST: Update Path Status 
 */
router.post('/changePathStatus/', function(req, res) {

    var doc = req.body;
    var PathID = doc.PathID; 
    var o_id = new mongo.ObjectID(PathID);
...
/*
 * POST: Update Opt Status 
 */
router.post('/changeOptStatus/', function(req, res) {

    var doc = req.body;
    var OptID = doc.OptID; 
    var o_id = new mongo.ObjectID(OptID);
